...
SERVER_ADDRESSES = ['slave1 IP:50051','slave2 IP:50051','slave3 IP:50051']  # Add more addresses as needed
...
def serve():
    ...
    server.add_insecure_port('172.31.26.55:50051')
    server.start()
    print("Master 2 started on port 50051")
